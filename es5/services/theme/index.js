...
function (_Service) {
  ...
  function Theme(preset) {
    ...
    var _preset$Theme$propert = preset[Theme.property],
        ...
        shadowMode = _preset$Theme$propert.shadowMode;
    _this.dark = Boolean(dark);
    _this.defaults = _this.themes = themes;
    _this.options = options;
    _this.shadowMode = !!shadowMode;
  ...
  _createClass(Theme, [{
    ...
    value: function checkOrCreateStyleElement() {
      ...
      if (this.shadowMode && this.shadowRoot && this.shadowRoot instanceof ShadowRoot) {
        this.styleEl = this.shadowRoot.getElementById('vuetify-theme-stylesheet');
      } else {
    ...
    key: "initShadowRoot",
    value: function initShadowRoot(root) {
      var rootNode = root && root.$root && root.$root.$el && root.$root.$el.getRootNode(); // Only assign shadowRoot if valid
